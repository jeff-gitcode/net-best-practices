namespace minimal_caching_demo.Presentation.Extensions;
...
public static class ProgramExtensions
{
    public static WebApplicationBuilder ConfigureBuilder(this WebApplicationBuilder builder)
    {
        ...
        _ = builder.Services.AddSwaggerGen(options =>
        {
            options.SwaggerDoc("v1",
                ...
                {
                    Version = "v1",
                    Title = $"minimal_caching_demo API - {ti.ToTitleCase(builder.Environment.EnvironmentName)} ",
                    Description = "An example to share an implementation of Minimal API in .NET 6.",
                    Contact = new OpenApiContact
                    {
                        Name = "minimal_caching_demo API",
                        Email = "minimal_caching_demo@stphnwlsh.dev",
                        Url = new Uri("https://github.com/stphnwlsh/minimal_caching_demo")
                    },
                    License = new OpenApiLicense()
                    {
                        Name = "minimal_caching_demo API - License - MIT",
                        Url = new Uri("https://opensource.org/licenses/MIT")
                    },
                    TermsOfService = new Uri("https://github.com/stphnwlsh/minimal_caching_demo")
                });
    ...
    public static WebApplication ConfigureApplication(this WebApplication app)
    {
        ...
        _ = app.UseSwagger();
        _ = app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", $"minimal_caching_demo - {ti.ToTitleCase(app.Environment.EnvironmentName)} - V1"));
