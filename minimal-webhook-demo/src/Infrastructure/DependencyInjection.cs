namespace minimal_webhook_demo.Infrastructure;
...
using minimal_webhook_demo.Infrastructure.Webhook;
...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services)
    {
        ...
        _ = services.AddSingleton<IReceiveWebhook, ConsoleWebhookReceiver>();
